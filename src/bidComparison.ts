import { iqrBounds, median, zScore } from './detectors/stats.js';
import type { BidBenchmark, BidComparisonResult, QuoteSubmission } from './types.js';
...
export function compareQuote(
  ...
  const descriptionByVerdict: Record<'HIGH' | 'NORMAL' | 'LOW', string> = {
...
export function compareQuotes(quotes: QuoteSubmission[], benchmarks: BidBenchmark[]): BidComparisonResult[] {
